    ...
    render() {
        return(
            <Navbar bg="black" className="navbar">
                <ul>
                    <li><Badge color="error" overlap="circle" badgeContent="0" variant="dot"><Nav.Link className="navLink" href="/">FireMap</Nav.Link></Badge></li>
                    ...
                    <li><Badge color="error" badgeContent="0" overlap="circle" variant="dot"><Nav.Link className="navLinkk" href="/feed">Report Feed</Nav.Link></Badge></li>
